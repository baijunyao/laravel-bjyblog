...
--
-- Host: 127.0.0.1	Database: sql_v11_0_0
-- ------------------------------------------------------
...
--
-- Table structure for table `bjy_article_histories`
--
...
CREATE TABLE `bjy_article_histories` (
  ...
  `markdown` mediumtext COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `bjy_article_histories`
--

LOCK TABLES `bjy_article_histories` WRITE;
/*!40000 ALTER TABLE `bjy_article_histories` DISABLE KEYS */;
SET autocommit=0;
/*!40000 ALTER TABLE `bjy_article_histories` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `bjy_article_histories` with 0 row(s)
--
...
CREATE TABLE `bjy_articles` (
  ...
  `category_id` tinyint unsigned NOT NULL DEFAULT '0' COMMENT '分类id',
...
CREATE TABLE `bjy_categories` (
  ...
  `pid` tinyint unsigned NOT NULL DEFAULT '0' COMMENT '父级栏目id',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `bjy_comments` (
  ...
  `socialite_user_id` int unsigned NOT NULL DEFAULT '0',
  `article_id` int unsigned NOT NULL,
  `content` text COLLATE utf8_unicode_ci NOT NULL,
  `is_audited` tinyint unsigned NOT NULL,
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `bjy_comments__lft__rgt_parent_id_index` (`_lft`,`_rgt`,`parent_id`)
...
SET autocommit=0;
INSERT INTO `bjy_comments` VALUES (1,1,1,'评论的内容',1,1,2,0,'2017-07-15 23:35:12','2016-07-15 23:35:12',NULL),(2,1,1,'已删除',1,3,4,0,'2019-01-04 08:35:12','2019-01-04 08:35:12','2019-01-04 08:35:12');
...
CREATE TABLE `bjy_friendship_links` (
  ...
  `sort` tinyint unsigned DEFAULT '1' COMMENT '排序',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
SET autocommit=0;
INSERT INTO `bjy_navs` VALUES (1,1,'随言碎语','note','2018-08-04 04:41:26','2018-08-04 04:41:26',NULL),(2,1,'开源项目','openSource','2018-08-04 04:41:26','2018-08-04 04:41:26',NULL),(3,1,'已删除','deleted','2019-01-04 08:35:12','2019-01-04 08:35:12','2019-01-04 08:35:12');
...
CREATE TABLE `bjy_oauth_clients` (
  ...
  `personal_access_client` tinyint unsigned NOT NULL,
  `password_client` tinyint unsigned NOT NULL,
  `revoked` tinyint unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `bjy_open_sources`
--
...
CREATE TABLE `bjy_socialite_users` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `socialite_client_id` tinyint unsigned NOT NULL DEFAULT '1' COMMENT '类型 1：QQ  2：新浪微博 3：github',
  ...
  `is_admin` tinyint unsigned NOT NULL DEFAULT '0' COMMENT '是否是admin',
...
SET autocommit=0;
INSERT INTO `bjy_users` VALUES (1,'test','test@test.com',NULL,'$2y$10$nmb2XAnGAGc4819LbT.CEuatZokJqb.5H9rHq.3S2P9Dkv.uN0cLq',NULL,'2016-10-21 23:35:12','2016-10-21 23:35:12',NULL),(2,'已删除','deleted@test.com',NULL,'$2y$10$jbuzB8B.RWJQup5MZwPOqOIlQdKGMhxZyCr/.Q.DnF3ylE2r0dqW6',NULL,'2019-01-04 07:35:12','2016-01-04 07:35:12','2016-01-04 07:35:12');
