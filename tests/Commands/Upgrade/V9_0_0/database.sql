...
--
-- Host: 127.0.0.1	Database: sql_v9_0_0
-- ------------------------------------------------------
...
CREATE TABLE `bjy_comments` (
  ...
  `type` tinyint unsigned NOT NULL DEFAULT '1' COMMENT '1：文章评论',
  `pid` int unsigned NOT NULL DEFAULT '0' COMMENT '父级id',
  `article_id` int unsigned NOT NULL COMMENT '文章id',
  `content` text COLLATE utf8_unicode_ci NOT NULL COMMENT '内容',
  `is_audited` tinyint unsigned NOT NULL COMMENT '是否已经通过审核',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
SET autocommit=0;
INSERT INTO `bjy_users` VALUES (1,'test','test@test.com',NULL,'$2y$10$Xoywn.b8ThjJ1tjSvXjZK.82b7i/C1x5w61ICiMo5Wsc5yuR6EOp.',NULL,'2016-10-21 23:35:12','2016-10-21 23:35:12',NULL),(2,'已删除','deleted@test.com',NULL,'$2y$10$lcH0Ac3h4nQTAX1f3n5rHOZ7P3BC2jahiohaJfOqpvZE.C5gaI4UG',NULL,'2019-01-04 07:35:12','2016-01-04 07:35:12','2016-01-04 07:35:12');
