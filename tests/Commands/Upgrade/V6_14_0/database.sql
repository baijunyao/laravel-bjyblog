...
--
-- Host: 127.0.0.1	Database: sql_v6_14_0
-- ------------------------------------------------------
...
SET autocommit=0;
INSERT INTO `bjy_users` VALUES (1,'test','test@test.com',NULL,'$2y$10$gI18oIqPlLKBZNWSo6W6kOHfjaj/QiidbHe1KKOpm5.f4y/cuG.5W',NULL,'2016-10-21 23:35:12','2016-10-21 23:35:12',NULL),(2,'已删除','deleted@test.com',NULL,'$2y$10$CLT7.5NU/ZkopIYjBJvtl.ExlQe0izIlqawSVkoha1NEh59ufnCcm',NULL,'2019-01-04 07:35:12','2016-01-04 07:35:12','2016-01-04 07:35:12');
...
--
-- Table structure for table `bjy_visits`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bjy_visits` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `primary_key` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `secondary_key` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `bjy_visits_primary_key_secondary_key_unique` (`primary_key`,`secondary_key`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `bjy_visits`
--

LOCK TABLES `bjy_visits` WRITE;
/*!40000 ALTER TABLE `bjy_visits` DISABLE KEYS */;
SET autocommit=0;
INSERT INTO `bjy_visits` VALUES (1,'visits:articles_visits','1',666,'','2020-02-11 23:35:12','2020-02-11 23:35:12','2020-02-11 23:35:12'),(2,'visits:articles_visits','2',222,'','2020-02-11 23:35:12','2020-02-11 23:35:12','2020-02-11 23:35:12'),(3,'visits:articles_visits','3',333,'','2020-02-11 23:35:12','2020-02-11 23:35:12','2020-02-11 23:35:12');
/*!40000 ALTER TABLE `bjy_visits` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `bjy_visits` with 3 row(s)
--
