...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('statics/font-awesome-4.4.0/css/font-awesome.min.css') }}">
                ...
                <div class="b-link">
                    ...
                    <p>
                        <foreach name="links" key="k" item="v">
                            <a class="b-link-a" href="{$v[url]}" target="_blank"><span class="fa fa-link b-black"></span> {$v['lname']}</a>
                        </foreach>
                    </p>
                </div>
            </eq>
        ...
        <footer id="b-foot" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <ul>
                <li class="text-center">
                    本站使用自主开发的<a rel="nofollow" href="http://git.oschina.net/shuaibai123/thinkbjy" target="_blank">bjyblog v{$Think.config.THINK_INFORMATION}</a>开源博客程序搭建  © 2014-2016 baijunyao.com 版权所有 ICP证：豫ICP备14009546号-3
                </li>
                <li class="text-center">
